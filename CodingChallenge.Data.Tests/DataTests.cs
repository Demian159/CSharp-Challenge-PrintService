...
namespace CodingChallenge.Data.Tests
{
    ...
    {
        public PrintShapeService PrintShapeService { get; set; } = new PrintShapeService();
        [TestCase]
        public void TestResumenListaVacia()
        {
            Assert.AreEqual("<h1>Lista vacía de formas!</h1>", PrintShapeService.Print(new List<Shape>(), LanguageIdentifier.Spanish));
        }

        [TestCase]
        public void TestResumenListaVaciaFormasEnIngles()
        {
            Assert.AreEqual("<h1>Empty list of shapes!</h1>", PrintShapeService.Print(new List<Shape>(), LanguageIdentifier.English));
        }
        ...
        public void TestResumenListaConUnCuadrado()
        {
            ...
            var actual = PrintShapeService.Print(cuadrados, LanguageIdentifier.Spanish);
        ...
        public void TestResumenListaConMasCuadrados()
        {
            ...
            var actual = PrintShapeService.Print(cuadrados, LanguageIdentifier.English);
        ...
        public void TestResumenListaConMasTipos()
        {
            ...
            var actual = PrintShapeService.Print(formas, LanguageIdentifier.English);
        ...
        public void TestResumenListaConMasTiposEnCastellano()
        {
            ...
            var actual = PrintShapeService.Print(formas, LanguageIdentifier.Spanish);
